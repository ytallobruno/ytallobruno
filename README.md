...
|  BACK-END   |  FRONT-END  | TESTES  | BANCOS DE DADOS |                                  CLOUD & MONITORAMENTO                                  |
| :---------: | :---------: | :-----: | :-------------: | :-------------------------------------------------------------------------------------: |
|   Java 17   | HTML / CSS  |  Jest   |      MySQL      | AWS (SQS, aws Lambda, CloudWatch, CodeBuild, CodePipeline, RDS, ECS, Step Function, S3) |
| Spring Boot |    React    | Vitest  |       SQL       |                                      Azure DevOps                                       |
|   Quarkus   |   Next.js   | Cypress |     MongoDB     |                                         Kibana                                          |
|   WebFlux   |  Bootstrap  |  JUnit  |    DynamoDB     |                                         DataDog                                         |
|   Node.js   |  Tailwind   | Mockito |    Hibernate    |                                                                                         |
| TypeScript  |  Chakra UI  |         |                 |                                                                                         |
| JavaScript  | Material UI |         |                 |                                                                                         |

|   API    | INFRAESTRUTURA | CONTROLE DE VERSÃO | METODOLOGIAS |
| :------: | :------------: | :----------------: | :----------: |
|   REST   |     Docker     |        Git         |    Scrum     |
| GraphQL  |   Terraform    |       GitHub       |    Kanban    |
| Gravitee |                |       GitLab       |     Jira     |
| Postman  |                |     Bitbucket      |  Confluence  |
|          |                |      GitFlow       | Code Review  |

<h2 id="projetos">Projetos mais importantes 📌 </h2>

- [x] [Maia Team Landing Page](https://lmaiateam.netlify.app/) (Typescript, Next, Framer Motion, Tailwind)
...
- [x] [Portfólio](https://github.com/ytallobruno/portfolio-v2) (Typescript, Next, Tailwind, Axios, ESLint, Prettier)
...
- Me formei em Administração no ano de 2018 e irei concluir minha segunda graduação em junho de 2026
